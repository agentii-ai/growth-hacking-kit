...
echo "========================================="
echo "Growth-Hacking-Kit Template Builder"
echo "========================================="
echo "Version: $VERSION"
echo "Source: .growthkit/ directory"
echo "Target: .growthkit/ directory (multi-kit coexistence)"
...
echo "  2. Inspect structure: ls -la /tmp/test/spec-kit-template-claude-sh-$VERSION/.growthkit/"
echo "  3. Run validation: ./scripts/validate-templates.sh $DIST_DIR"
